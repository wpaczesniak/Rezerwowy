...
class BuyerTest {
    ...
    @Test
    void should_validate_when_nameIsOfShortLength() {
        // given
        Buyer buyer = BuyerFactory.createProperBuyerCase1();
        String name = "Jan";
    ...
    @Test
    void should_validate_when_nameIsOfMediumLength() {
        // given
    ...
    @Test
    void should_notValidate_when_nameIsVeryLong() {
        // given
        Buyer buyer = BuyerFactory.createProperBuyerCase1();
    ...
    @Test
    void should_validate_when_surnameIsOfMediumLength() {
        // given
        Buyer buyer = BuyerFactory.createProperBuyerCase2();
    ...
    @Test
    void should_notValidate_when_surnameIsVeryLong() {
        // given
        Buyer buyer = BuyerFactory.createProperBuyerCase1();
